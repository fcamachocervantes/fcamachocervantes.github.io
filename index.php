    ...
    <body>
        <div class="container">
            ...
            <article id="MinesExperience">
                ...
                <p>
                    Cyber Defense Education Certificate (CAE-CDE)
                    <br>
            ...
            <article id="WorkExperience">
                ...
                <ul>
                    <li>
                        Developed prototype front-end application.
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        Collaborated with multitude of people of varying 
                        backgrounds to produce high quality software solutions with practical 
                        backgrounds.
                    </li>
                    <li>
                        Honed communication skills to effectively communicate with group members
                        to deliver projects on time while meeting and exceeding standards.
                    </li>
                    <li>
                        Learned how to put conceptual architectures into practice to meet efficiency
                        and usability standards.
                    </li>
                    <li>
                        Developed strategies for gathering information to learn a more in-depth 
                        understanding about difficult to grasp concepts.
                    </li>
                </ul>
                <h4>
                    Research Project
                ...
                <ul>
                    <li>
                        Developed methodology to measure usability of ChatGPT to teach Rust.
                    </li>
                    <li>
                        Developed secure C code for participants to use within the study.
                    </li>
                    <li>
                        Utilized proper human research protocols.
                    </li>
                    <li>
                        Recruited Participants and trained them to conduct the experiments of our study.
                    </li>
                    <li>
                        Performed code analysis to search for potential vulnerabilities.
                    </li>
                    <li>
                        Coded responses from participants for statistical analysis.
                    </li>
                    <li>
                        Taught participants the important distinctions between Rust and C.
                    </li>
                </ul>
            </article>
            <article id="SkillsInterests">
                ...
                <ul>
                    ...
                    <li>
                        C, C++, Python: 4 years of experience
                    </li>
                    <li>
                        JavaScript, HTML5, CSS3, SQL, PHP: 2 years of experience
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        Intersection between people and computers and effects on
                        security & privacy.
                    </li>
                    <li>
                        Ethical implications of software development while ensuring
                        security & privacy.
                    </li>
                    <li>
                        How to promote secure software development.
                    </li>
                    <li>
                        AI/LLMs and their use cases for detecting security issues in
                        code.
                    </li>
                    <li>
                        How to teach unexperience people best security practices to protect them.
                    </li>
                    <li>
                        New innovations occuring in consumer computer hardware and software technologies.
                    </li>
                </ul>
            </article>
